 ...
 *	 Author	        : WangShb
 *	 Description    : hardware configuration(MB9BF506R).
 *-------------------------------------------------------------------------------
 */
...
#define CRYSTAL_ENABLE_MOSC     0x02 /*Enable main oscilation             */
#define CRYSTAL_ENABLE_PLL      0x10 /*Enable pll clock                   */
#define CRYSTAL_ENABLE_MCK      0x22 /*Set Main as Master Clock,and Enable*/
#define CRYSTAL_ENABLE_PCK      0x50 /*Set PLL as Master Clock,and Enable */
