 ...
 *	 Author	        : Wangxd
 *	 Description    : hardware configuration(LPC1788).
 *-------------------------------------------------------------------------------
 */
...
#define CRYSTAL_ENABLE_MOSC     0x00000021 /*Set OSC_CLK as Source */
...
#define CRYSTAL_ENABLE_PCK      0x00000100 /*Switch PLL as System Clock         */


#define INTERNAL_RAM_SIZE       0x00010000
#define INTERNAL_RAM_START      0x10000000
#define INTERNAL_RAM_END        0x10010000
