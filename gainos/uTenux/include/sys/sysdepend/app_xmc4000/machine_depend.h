 ...
 *	 Description    : Machine type definition(sys/XMC4000).
 *-------------------------------------------------------------------------------
 */
...
/* ----- uTenux Appliance XMC4000 (ARM CORTEX M4) definition ----- */

#undef _APP_XMC4000_

#define _APP_XMC4000_		        1
#define CPU_ARM7M		            1
#define CPU_XMC4000	        	    1
#define APP_XMC4000		            1
