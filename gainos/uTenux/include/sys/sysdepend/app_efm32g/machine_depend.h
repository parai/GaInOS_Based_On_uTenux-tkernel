 ...
 *	 Create Date    : 2009/12/27-2012/7/18
 *	 Author	        : Wangxd
 *	 Description    : Machine type definition(sys/EFM32G).
 *-------------------------------------------------------------------------------
 */
...
/* ----- uTenux Appliance EFM32G890F128(ARM CORTEX M3) definition ----- */

#undef _APP_EFM32G_

#define _APP_EFM32G_		        1
#define CPU_ARM7M		            1
#define CPU_EFM32G  	        	1
#define APP_EFM32G  		        1
