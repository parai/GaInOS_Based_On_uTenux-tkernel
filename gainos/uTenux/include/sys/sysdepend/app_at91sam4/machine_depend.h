 ...
 *	 Author	        : wangxd
 *	 Description    : Machine type definition(sys/AT91SAM4).
 *-------------------------------------------------------------------------------
 */
...
/* ----- uTenux Appliance AT91SAM4 (ARM CORTEX M4) definition ----- */

#undef _APP_AT91SAM4_

#define _APP_AT91SAM4_		        1
#define CPU_ARM7M		            1
#define CPU_AT91SAM4	        	1
#define APP_AT91SAM4		        1
