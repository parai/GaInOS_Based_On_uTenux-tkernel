 ...
 *	 Create Date    : 2009/12/27-2012/7/27
 *	 Author	        : WangShb
 *	 Description    : Machine type definition(sys/AT91SAM3).
 *-------------------------------------------------------------------------------
 */
...
/* ----- uTenux Appliance AT91SAM3 (ARM CORTEX M3) definition ----- */

#undef _APP_AT91SAM3_

#define _APP_AT91SAM3_		        1
#define CPU_ARM7M		            1
#define CPU_AT91SAM3	        	1
#define APP_AT91SAM3		        1
