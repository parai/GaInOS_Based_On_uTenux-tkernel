...
#	 Create Date    : 2012/7/19-2012/9/26
#	 Author	        : wangshb-zhangzl
#	 Description    : Gdb Script for J-Link 4.36l above.
...
monitor flash device = MB9BF506R
...
echo load bin/app_mb9bf5/kernel-rom.mot

echo symbol-file bin/app_mb9bf5/kernel-rom.rom
