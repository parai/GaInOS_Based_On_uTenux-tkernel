...
#	 Description    : Gdb Script for J-Link 4.52a above.

#                     Step1:  Connect to the J-Link gdb server# Step2: Set gdb server to little endian
...
echo load bin/app_stm32f4/kernel-rom.mot

echo symbol-file bin/app_stm32f4/kernel-rom.rom
