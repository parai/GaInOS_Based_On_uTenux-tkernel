 ...
 *	 Create Date    : 2012/7/20-2012/11/30
 *	 Author	        : Zhangzl-Zhangzl
 *	 Description    : System Configuration Definition(MK60N512VMD100).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x1fff0000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x1fffc000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x1fff7000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x1fffc000)
...
#define STACK_TOP        0x20000000	 /* SRAM system area end */
...
#define USER_BOOT_MESSAGE \
    ...
    "      Supported MCU is Freescale MK60N512VMD100     \n" \
