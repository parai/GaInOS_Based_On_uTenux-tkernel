 ...
 *	 Create Date    : 2009/12/27-2013/1/24
 *	 Author	        : Wangxd-zhangzl
 *	 Description    : System Configuration Definition(lpc1788).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x10000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x1000d000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x10008000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x1000d000)
...
#define STACK_TOP        0x10010000	/* SRAM system area end */
