 ...
 *	 Description    : System Configuration Definition(lpc1766).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x10000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x10006000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x10004000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x10006000)
...
#define STACK_TOP        0x10008000	/* SRAM system area end */
