 ...
 *	 Description    : System Configuration Definition(MB9BF506R).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x20006000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x20004000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x20006000)
...
#define USER_BOOT_MESSAGE \
    ...
    "          Supported MCU is FUJITSU MB9BF506R        \n" \
