 ...
 *	 Create Date    : 2009/9/16-2013/1/16
#	 Author	        : dengjk-dengjk
 *	 Description    : System Configuration Definition(sim3u167bgq).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20001000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x20007400	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x20004400	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x20007400)
...
#define STACK_TOP        0x20008000	/* SRAM system area end */
...
#define USER_BOOT_MESSAGE \
    ...
    "          Supported MCU is SILABS SIM3X16X          \n" \
