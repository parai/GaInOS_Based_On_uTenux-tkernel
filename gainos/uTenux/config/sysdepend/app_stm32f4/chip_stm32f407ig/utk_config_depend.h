 ...
 *	 Description    : System Configuration Definition(STM32F407IG).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* SRAM system area top */
#define SYSTEMAREA_END	0x20018000	/* SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x2000D000	/* SRAM user area middle */
...
#define STACK_TOP     0x2001C000	/* SRAM system area end */
...
#define USER_BOOT_MESSAGE \
    ...
    "            Supported MCU is ST STM32F407IG         \n" \
