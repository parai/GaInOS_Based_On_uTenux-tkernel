 ...
 *	 Description    : System Configuration Definition(efm32g890f128).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x20003800	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x20002300	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x20003800)
...
#define STACK_TOP        0x20004000	/* SRAM system area end */
...
#define USER_BOOT_MESSAGE \
    ...
    "         Supported MCU is  EnergyMicroEFM32G8       \n" \
