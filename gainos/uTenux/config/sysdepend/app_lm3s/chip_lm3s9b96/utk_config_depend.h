 ...
 *	 Description    : System Configuration Definition(LM3S9B96).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x20016000	/* first SRAM system area end */

/* User definition */
#define RI_USERAREA_TOP	0x20008000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x20016000)
...
#define STACK_TOP     0x20018000	/* SRAM system area end */
