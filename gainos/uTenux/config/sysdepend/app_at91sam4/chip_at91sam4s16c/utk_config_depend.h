 ...
 *	 Description    : System Configuration Definition(at91sam4s16c).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x20018000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x20015000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x20018000)
...
#define STACK_TOP        0x20020000	/* SRAM system area end */
...
#define USER_BOOT_MESSAGE \
    ...
    "          Supported MCU is ATMEL AT91SAM4S16C       \n" \
