 ...
 *	 Description    : System Configuration Definition(XMC4500F144K1024).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x2000c000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x20007000	/* first SRAM user area middle */
...
#define STACK_TOP        0x2000ffff	/* SRAM system area end */
...
#define USER_BOOT_MESSAGE \
    ...
    "     Supported MCU is Infineon XMC4500F144K1024     \n" \
