 ...
 *	 Description    : System Configuration Definition(LM4F232H5QD).
 *-------------------------------------------------------------------------------
 */

/* RAMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* first SRAM system area top */
#define SYSTEMAREA_END	0x20007000	/* first SRAM system area end */


/* User definition */
#define RI_USERAREA_TOP	0x20006000	/* first SRAM user area middle */
...
#define CFN_REALMEMEND		((VP) 0x20007000)
